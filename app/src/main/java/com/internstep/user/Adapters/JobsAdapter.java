...
public class JobsAdapter extends RecyclerView.Adapter<JobsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        //final Companies company = mjob_positions.get(i);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(Objects.requireNonNull(snapshot.child("company_name").getValue()).toString().equals(screen)) {
                        ...
                        //Log.d("company", company.getCompany_name());
                    }
                    //}
                }
        ...
        //ArrayList<String> job_roles = (ArrayList<String>) .getJob_roles();
        //String job_role = mjob_positions.toString();
