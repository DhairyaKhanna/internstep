    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                users.setShort_description(info_description.getText().toString());

                /*if (users.getJob_title().equals("default")) {
                    users.setJob_title(info_job.getText().toString());
                }
                if (users.getEducation().equals("default")) {
       ...
       // });
        ...
        /*info_description.addTextChangedListener(new TextWatcher() {

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (info_description.getText().length() >= 141){
                     str = info_description.getText().toString().substring(0, 140);
                    info_description.setText(str);
                    info_description.setSelection(str.length());
                }
            }
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /*reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        User users = dataSnapshot.getValue(User.class);
                        String str2 = users.getShort_description();

                        //HashMap<String,String> hashMap= new HashMap<>();
                        //hashMap.put("short_description",str1);
                        Log.i("cross",str2);
                        //dataSnapshot.getRef().child("short_description").setValue(str);
                        //users.setShort_description(str1);
                        Log.i("string",users.getShort_description());
                /*if (users.getJob_title().equals("default")) {
                    users.setJob_title(info_job.getText().toString());
                }
                if (users.getEducation().equals("default")) {
